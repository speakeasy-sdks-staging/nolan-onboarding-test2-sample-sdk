...
package nolanonboardingtest2samplesdk

import (
	"context"
	"fmt"
	"github.com/speakeasy-sdks-staging/nolan-onboarding-test2-sample-sdk/pkg/models/shared"
	"github.com/speakeasy-sdks-staging/nolan-onboarding-test2-sample-sdk/pkg/utils"
	"net/http"
	"time"
)
...
func New(opts ...SDKOption) *TheSpeakeasyBar {
	sdk := &TheSpeakeasyBar{
		sdkConfiguration: sdkConfiguration{
			...
			SDKVersion:        "0.1.0",
			GenVersion:        "2.154.1",
			UserAgent:         "speakeasy-sdk/go 0.1.0 2.154.1 1.0.0 github.com/speakeasy-sdks-staging/nolan-onboarding-test2-sample-sdk",
		},
	}
